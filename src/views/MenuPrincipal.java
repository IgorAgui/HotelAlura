...
public class MenuPrincipal extends JFrame {
	...
	*/
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desenvolvido por Igor Aguiar © 2023");
		lblCopyR.setBounds(315, 11, 301, 19);
		lblCopyR.setForeground(new Color(240, 248, 255));
		lblCopyR.setFont(new Font("Tahoma", Font.PLAIN, 18));
		...
		imageLogin.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/Img/login.png")));
